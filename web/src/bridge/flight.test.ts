...
import { decodeFlightStatus, dockedLocationID } from "./flight.ts";
...
test("dockedLocationID prefers stationID then structureID", () => {
  assert.equal(dockedLocationID({ stationID: 60003760, structureID: null }), 60003760);
  assert.equal(dockedLocationID({ stationID: null, structureID: 1030000000001 }), 1030000000001);
  assert.equal(dockedLocationID({ stationID: 60003760, structureID: 1030000000001 }), 60003760);
  assert.equal(dockedLocationID({ stationID: null, structureID: null }), null);
});
