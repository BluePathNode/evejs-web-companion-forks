...
function isAtDestination(status: FlightStatus, plan: CompiledPlan): boolean {
  ...
  // NPC stations report stationID; Upwell structures report structureID. Either
  // matching the planned dock destination counts as arrived.
  return plan.destinationStationID === null || dockedLocationID(status) === plan.destinationStationID;
}
