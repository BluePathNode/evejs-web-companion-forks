// B1 Ã¢â‚¬â€ the macro adapters' key transitions. Pins each block's task loop so a
...
test("mine: rock locked at 7km Ã¢â‚¬â€ an orbit of 5km overshooting a little Ã¢â‚¬â€ still activates", () => {
...
test("deliver: docked at Upwell structure target (structureID) -> unload/done", () => {
  const structureStep: MacroStep = {
    id: "h",
    kind: "macro",
    macro: "deliver-ore",
    args: { station: { kind: "station", ref: { entity: "station", id: 1030000000001, name: "Citadel", systemName: null } } },
  };
  const withOre: MiningHold[] = [{ key: "ore", label: "Ore Hold", items: [{ itemID: 8, typeID: 1230, quantity: 100 }], capacity: null, present: true, error: null }];
  const unload = deliver(
    structureStep,
    obs({ flightStatus: flight({ docked: true, inSpace: false, stationID: null, structureID: 1030000000001 }), holds: withOre }),
    NM,
    {},
  );
  assert.equal(unload.action.kind, "unloadOre");
  const done = deliver(
    structureStep,
    obs({ flightStatus: flight({ docked: true, inSpace: false, stationID: null, structureID: 1030000000001 }), holds: [] }),
    NM,
    {},
  );
  assert.equal(done.outcome.kind, "done");
...
test("travel-to-station: docked via structureID at target -> done", () => {
  ...
  const arrived = travelTo(
    s,
    obs({ flightStatus: flight({ docked: true, inSpace: false, stationID: null, structureID: 1030000000001 }), snapshot: null }),
    {},
    {},
  );
...
test("travel-to-station: rides the shared autopilot (multi-system) and is done only at the TARGET", () => {
  ...
  // Docked SOMEWHERE ELSE is not arrived Ã¢â‚¬â€ it heads out again.
...
test("loot: only YOUR wrecks are ever opened Ã¢â‚¬â€ others' and unknown-owner wrecks never", () => {
...
test("loot-containers: any container is fair game, no ownership check", () => {
  ...
  // Nearest wins regardless of owner Ã¢â‚¬â€ unlike loot-wrecks, nothing here is off limits.
  const t = loot(s, obs({ snapshot: snapshot([mine, theirs, unknown]), myCharacterID: 90000001 }), {}, {});
...
test("loot-containers: an empty read right after arrival waits out a settle window instead of leaving immediately", () => {
  // No natural pause the way a player starting the bot by hand gets Ã¢â‚¬â€ landing
...
test("loot-containers: still on grid after a loot attempt -> tried again, never silently believed emptied", () => {
  ...
  // the instant it truly is) Ã¢â‚¬â€ so seeing it again next tick means the transfer
...
test("loot-containers: a can that keeps refusing for MAX_BLOCK_ATTEMPTS is set aside, not looped forever", () => {
  ...
  // MAX_BLOCK_ATTEMPTS is 5 (scriptMacros.ts, not exported) Ã¢â‚¬â€ this is the 6th try.
...
test("fight: locks the NEAREST rat, drones on it, then every idle gun on it", () => {
  ...
  // Locked: drones onto it firstÃ¢â‚¬Â¦
  const engage = fight(
    s,
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Named board slots Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
test("a station arg can point at a BOARD SLOT an earlier block filled in", () => {
  ...
  // The board says the agent's station is 60009999 Ã¢â‚¬â€ and we are docked there, so
  ...
  // With the slot UNFILLED the block blocks with a plain reason Ã¢â‚¬â€ never a guess.
  const empty = travel(slotStep, docked, {}, {});
  assert.equal(empty.outcome.kind, "blocked");
});

// Ã¢â€â‚¬Ã¢â€â‚¬ The market set Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ The fleet-support set Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Remote assistance has a range, and a bound Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
//
// Ã¢Å¡Â  BOTH REMOTE BLOCKS USED TO RETURN `mem` UNCHANGED after issuing an activate.
...
// parked out of reach was an infinite loop Ã¢â‚¬â€ the bot would sit there locking and
...
test("remote-rep: reps that never come on are BOUNDED (this was an infinite loop)", () => {
  const hurt = entity({ itemID: 7001, kind: "ship", characterID: 5001, shieldRatio: 0.4, armorRatio: 1, hullRatio: 1 });
  const world = obs({
    // The rep never appears in activeModuleIDs Ã¢â‚¬â€ the shape of a silent refusal.
...
test("remote-rep: a rep that IS cycling refills the budget Ã¢â‚¬â€ no mid-fight stall", () => {
  ...
  assert.equal(fired, 6, "a landed rep means the budget is not spent Ã¢â‚¬â€ keep working the second one");
});
...
test("orbit-and-boost: closes by ORBITING Ã¢â‚¬â€ it must not also issue an approach", () => {
...
test("remote-rep: an NPC or your own hull is never a rep target", () => {
  ...
  // No FRIENDLY is hurt (the NPC is skipped), so the block is done Ã¢â‚¬â€ never reps a rat.
...
// Ã¢â€â‚¬Ã¢â€â‚¬ The fleet-management set Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ The PvP set Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
 ...
 * for something that has just landed on grid Ã¢â‚¬â€ and at 20 km the engage now
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Tackle before guns Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Closing the distance Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
//
...
test("attack-player: the approach is issued ONCE Ã¢â‚¬â€ the next tick fights, it does not re-approach", () => {
  const prey = playerShip(801, 90001, 20000);
  const world = obs({
  ...
  assert.equal(kinds[1], "activate", "and the very next tick is already fighting Ã¢â‚¬â€ the burn does not starve the guns");
});
...
test("attack-player: a new primary gets a fresh burn", () => {
  ...
  // Memory says we already closed on 801 Ã¢â‚¬â€ which has since left the grid.
...
test("attack-player: the tackle budget SURVIVES a long burn Ã¢â‚¬â€ the live failure", () => {
  // Ã¢Å¡Â  WATCHED HAPPEN, 2026-07-25. The bot undocked, closed on its target, said
  // "Guns on them" Ã¢â‚¬â€ and the target was neither pointed nor webbed and warped
...
test("attack-player: out of web range the POINT still fires and the web does not burn a try", () => {
  ...
  // live shape Ã¢â‚¬â€ the point lands, the web would only ever be refused.
  ...
  assert.ok(point.action.kind === "activate" && point.action.moduleID === 650, "the point outranges the web Ã¢â‚¬â€ it still goes on");
...
test("attack-player: a struggling POINT must not disarm the web Ã¢â‚¬â€ the second live failure", () => {
  // Ã¢Å¡Â  WATCHED HAPPEN, 2026-07-26, with the range checks already in. The point and
  // the web shared ONE counter, so the point spending it Ã¢â‚¬â€ coming on late, after
  // refusals in the band just past its optimal Ã¢â‚¬â€ left the web permanently idle.
...
test("hunt-player: roaming to a new system forgets the old system's scanner hits", () => {
  // Ã¢Å¡Â  `visitedHits` used to ride along on every jump. A hunt that came back to a
  // system it had already swept still counted those hits as visited and refused
  // to chase them Ã¢â‚¬â€ so the longer it roamed, the more of its own hunting ground
...
test("hunt-player: the BURN is remembered across ticks too, not re-issued forever", () => {
  // Ã¢Å¡Â  The hunt block hand-copies the combat keys into the engage, so anything
  ...
  // Ã¢â‚¬â€ and since only one action fires per tick, that starves the whole ladder:
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Movement extras, cargo extras, cap chain Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
test("mine: ore-family focus prefers matching rocks; default still any rock", () => {
  const veld = entity({ itemID: 50001, name: "Veldspar", miningYieldTypeID: 1230, position: { x: 2000, y: 0, z: 0 } });
  const merc = entity({ itemID: 50002, name: "Mercoxit", miningYieldTypeID: 11396, position: { x: 9000, y: 0, z: 0 } });
  const magma = entity({ itemID: 50003, name: "Magma Mercoxit", miningYieldTypeID: 11396, position: { x: 12000, y: 0, z: 0 } });
  const focused: MacroStep = {
    ...mineStep,
    id: "mf",
    args: { ...mineStep.args, focus: { kind: "rockFocus", name: "Mercoxit" } },
  };
  const t = mine(focused, obs({ snapshot: snapshot([veld, merc, magma]) }), NM, {});
  assert.ok(t.action.kind === "orbit" && t.action.targetID === 50002, "nearest Mercoxit, skipping closer Veldspar");

  const any = mine(mineStep, obs({ snapshot: snapshot([veld, merc, magma]) }), NM, {});
  assert.ok(any.action.kind === "orbit" && any.action.targetID === 50001, "default unchanged: nearest any rock");
});

test("mine: focus with no matching rocks at the belt blocks like an empty belt", () => {
  const veld = entity({ itemID: 50001, name: "Veldspar", miningYieldTypeID: 1230, position: { x: 2000, y: 0, z: 0 } });
  const belt = entity({ itemID: 40001, name: "Asteroid Belt 1", position: { x: 1000, y: 0, z: 0 } });
  const focused: MacroStep = {
    ...mineStep,
    id: "mf2",
    args: { ...mineStep.args, focus: { kind: "rockFocus", name: "Mercoxit" } },
  };
  const t = mine(focused, obs({ snapshot: snapshot([veld, belt]) }), NM, {});
  assert.equal(t.outcome.kind, "blocked");
  assert.match(t.outcome.kind === "blocked" ? t.outcome.reason : "", /Mercoxit/i);
});

// Ã¢â€â‚¬Ã¢â€â‚¬ compress-ore (the fleet mechanic) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
test("compress-ore: each stack gets ONE attempt, then the block finishes", () => {
  ...
  assert.deepEqual(attempted, [11, 12], "each stack once, in order Ã¢â‚¬â€ an ore with no compressed form is not retried forever");
  assert.equal(finishedOnTick, 2, "it finishes the tick after the last stack, never looping on a stubborn one");
  // Ã¢Å¡Â  The memory it finishes with is CLEARED, on purpose: the runner resets
...
test("compress-ore: an EMPTY hold is done; an UNREADABLE hold waits", () => {
  ...
  // items:null is "we could not look", NOT "it is empty" Ã¢â‚¬â€ it must not finish.
...
test("compress-ore / jettison: an UNREADABLE location waits, it does not say 'undock first'", () => {
  ...
  // a verdict; unreadable is not Ã¢â‚¬â€ telling a player to undock a ship whose place
...
test("mine: unknown activeModuleIDs waits - never treats null as off", () => {
  const mine = SCRIPT_MACROS["mine-at-belt"]!;
  const s: MacroStep = {
  ...
  const rock = entity({ itemID: 50001, name: "Veldspar", miningYieldTypeID: 1230, beltID: 1, position: { x: 3000, y: 0, z: 0 } });
  const t = mine(
    s,
    obs({
  ...
  assert.equal(t.action.kind, "wait");
  assert.match(t.why, /did not say which equipment/i);
});
