...
/** Collect finished industry jobs on a loop - the factory clerk. */
const FACTORY_CLERK: BotScript = {
  ...FORMAT,
  name: "Factory clerk",
  notes: "Collects every finished industry job, then checks again after a short break.",
  home: startingStation(),
  interrupts: [],
  program: [
    {
      ...
      repeat: { kind: "forever" },
      body: [
        { id: "s1", kind: "macro", macro: "deliver-ready-jobs", args: {} },
        { id: "s2", kind: "macro", macro: "wait", args: { seconds: { kind: "count", value: 120 } } },
      ],
    },
  ],
};
...
const OPERATIONS_CLOSEOUT: BotScript = {
  ...
  notes: "Docks, unloads, repairs, tidies the hangar, collects finished industry jobs, and checks every colony for expired extractors.",
  home: startingStation(),
  interrupts: [],
  program: [
    ...
    { id: "s5", kind: "macro", macro: "deliver-ready-jobs", args: {} },
    { id: "s6", kind: "macro", macro: "restart-extractors", args: {} },
  ],
};
...
export const EXAMPLE_BOTS: readonly ExampleBot[] = Object.freeze([
  ...
  { key: "factory", label: "Factory clerk", blurb: "Collect finished industry jobs on a loop.", doc: FACTORY_CLERK },
  ...
  { key: "operations-closeout", label: "Operations closeout", blurb: "Dock, unload, repair, tidy, collect jobs, check colonies.", doc: OPERATIONS_CLOSEOUT },
]);
